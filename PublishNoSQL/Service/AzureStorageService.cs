...
namespace PublishNoSQL.Service
{
    public class AzureStorage : IAzureStorage
    {
        ...
        {
            _storageConnectionString = Environment.GetEnvironmentVariable("BLOB_CONNECTION_STRING");
        ...
        public async Task<byte[]> GetPdfFileAsync(string blobFilename)
        {
            ...
            BlobClient file = client.GetBlobClient(blobFilename);
            await file.DownloadToAsync(memoryStream);
